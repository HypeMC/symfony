...
class IntegrationTest extends TestCase
{
    ...
    public function testClassMap()
    {
        ...
        $container->register('class_map_argument', ClassMapConsumer::class)
            ->setPublic('true')
        ...
        $clasMapConsumer = $container->get('class_map_argument');

        self::assertInstanceOf(ClassMapConsumer::class, $clasMapConsumer);
        self::assertSame([
            'baz-prop' => 'Symfony\Component\DependencyInjection\Tests\Fixtures\ClassMap\Valid\Baz',
            'corge-const' => 'Symfony\Component\DependencyInjection\Tests\Fixtures\ClassMap\Valid\Corge',
            'foo-attribute' => 'Symfony\Component\DependencyInjection\Tests\Fixtures\ClassMap\Valid\Foo',
            'foo-enum-attribute' => 'Symfony\Component\DependencyInjection\Tests\Fixtures\ClassMap\Valid\FooEnum',
