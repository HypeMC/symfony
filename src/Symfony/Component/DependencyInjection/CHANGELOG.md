 ...
 * Allow computing the `$index` and `$priority` arguments of `#[AsTaggedItem]`: pass a `\Closure` (requires PHP 8.5), or a `[class-string, method]` callable to a public static method (works on PHP 8.4)
