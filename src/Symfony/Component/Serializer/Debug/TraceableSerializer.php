...
class TraceableSerializer implements SerializerInterface, NormalizerInterface, DenormalizerInterface, EncoderInterface, DecoderInterface
{
    ...
    public function serialize(mixed $data, string $format, array $context = []): string
    {
        ...
        $this->dataCollector->collectSerialize($traceId, $data, $format, $context, $time, $caller, $this->scope);
    ...
    public function deserialize(mixed $data, string $type, string $format, array $context = []): mixed
    {
        ...
        $this->dataCollector->collectDeserialize($traceId, $data, $type, $format, $context, $time, $caller, $this->scope);
    ...
    public function normalize(mixed $object, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $this->dataCollector->collectNormalize($traceId, $object, $format, $context, $time, $caller, $this->scope);
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $this->dataCollector->collectDenormalize($traceId, $data, $type, $format, $context, $time, $caller, $this->scope);
    ...
    public function encode(mixed $data, string $format, array $context = []): string
    {
        ...
        $this->dataCollector->collectEncode($traceId, $data, $format, $context, $time, $caller, $this->scope);
    ...
    public function decode(string $data, string $format, array $context = []): mixed
    {
        ...
        $this->dataCollector->collectDecode($traceId, $data, $format, $context, $time, $caller, $this->scope);
